...
from fastapi_proj.source.schemas.users import UserBaseModel
from fastapi_proj.source.db.models import User
from fastapi_proj.source.crud.crud_users import (
    get_user_by_email,
    create_user,
    delete_user
)
...
class TestCrudUsers(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_user_by_email(self):
        ...
        self.async_session.execute.return_value = MagicMock(scalar_one=MagicMock(return_value=test_user))
    ...
    async def test_create_user(self):
        ...
        self.async_session.execute.return_value = MagicMock(scalar_one=MagicMock(return_value=new_user))
